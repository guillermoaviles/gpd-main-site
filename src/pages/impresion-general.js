...
const ImpresionGeneral = () => {
    return (
        <>
            <Layout>
                <section className="z-0 h-[100vh] bg-gray-light w-full bg-cover bg-top -mt-24">
                    <div className="relative">
                        <img className="w-full" src="/Heidelberg.png" alt="Impresión General Hero" />
                        <div className="absolute inset-y-0 top-0 left-0 h-full w-1/2">
                            <div className='h-8/12 w-8/12 mt-[20vh] mx-auto'>
                                <h2 className="mb-4 text-3xl lg:text-4xl font-bold font-heading wow animate__animated animate__fadeIn">
                                    <span className="text-transparent text-6xl bg-clip-text bg-gradient-to-r from-gpd-turquoise via-gpd-blue to-gpd-red">Impresión General</span>
                                </h2>
...
export default ImpresionGeneral;
