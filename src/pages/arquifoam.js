...
const Arquifoam = () => {
    return (
        <>
            <Layout>
                <section className="relative flex flex-col items-center justify-center w-full -mt-24 px-6 py-24 bg-gray-light bg-cover lg:py-32 min-w-screen 2xl:bg-[#f4f4f2] tails-selected-element">
